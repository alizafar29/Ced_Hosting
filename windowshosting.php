...
<html>
<head>
<title>Ced Hosting a Hosting Category Flat Bootstrap Responsive Website Template | Windows Hosting :: w3layouts</title>
									...
									<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
										...
										<?php
											...
											<div class="col-md-3 linux-price">
												<div class="linux-top">
												<h4 class="prodId" hidden><?php echo $value[0]?></h4>
												<h4 class="prodName"><?php echo $value[2]?></h4>
												</div>
												<div class="linux-bottom">
													<h5>&#8377; <span class="monthly"><?php echo $value[9]?></span> <span class="month">per month</span></h5>
													<h5>&#8377; <span class="annually"><?php echo $value[10]?></span> <span class="month">per Annum</span></h5>
													<h6>Single Domain</h6>
													<ul>
													<li><strong><?php echo $v -> Webspace ?>GB</strong> Disk Space</li>
													<li><strong><?php echo $v -> Bandwidth ?>GB</strong> Bandwidth</li>
													<li><strong><?php echo $v -> Mailbox ?></strong> Mailbox</li>
													<li><strong><?php echo $v -> Freedomain ?> </strong>  Free Domain</li>
													<li><strong><?php echo $v -> Technology ?> </strong>  Language/Technology</li>
													<li><strong>High Performance Server</strong>  Servers</li>
													<li><strong>location</strong> : <img src="images/india.png"></li>
													</ul>
												</div>
												<!-- <a value="" class="buy"   data-toggle="modal" data-target="#exampleModal">buy now</a> -->
												<a href="cart.php?action=cart&id=<?php echo $value[0]?>&name=<?php echo $value[2]?>&price=<?php echo $value[9]?>" class="buy">buy now</a>
